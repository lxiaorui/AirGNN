...
The models works well under poison setting (attacks happen before training) and evasion setting (attacks happen after training). It also works under multiple attacking methods since the method does not reply on how the features are attacked.
